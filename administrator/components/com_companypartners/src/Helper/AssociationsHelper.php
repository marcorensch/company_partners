...
namespace NXD\Component\Companypartners\Administrator\Helper;
...
class AssociationsHelper extends AssociationExtensionHelper
{
	 ...
	 * @since   __BUMP_VERSION__
	 */
	protected $extension = 'com_companypartners';
	...
	public function getItem($typeName, $id)
	{
		...
		switch ($typeName) {
			case 'partner':
				$table = Table::getInstance('PartnerTable', 'NXD\\Component\\Companypartners\\Administrator\\Table\\');
				break;
